...
class ControllersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create controller" do
    assert_difference('Controller.count') do
      post controllers_url, params: { controller: { StoreFlavor: @controller.StoreFlavor, flavor_id: @controller.flavor_id, store_id: @controller.store_id } }
    end
  ...
  test "should update controller" do
    patch controller_url(@controller), params: { controller: { StoreFlavor: @controller.StoreFlavor, flavor_id: @controller.flavor_id, store_id: @controller.store_id } }
